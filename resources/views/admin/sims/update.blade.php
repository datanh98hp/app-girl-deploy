...
@section('page-header')
    ...
    <div>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('admin.sim.index')}}">sim</a></li>
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <form action="{{route('admin.sim.update',$sim->id)}}" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" value="{{$sim->name}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="code" value="{{$sim->code}}"
                                               placeholder="Mã">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="price" value="{{$sim->price}}"
                                               placeholder="Giá bán">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="description" rows="3"
                                                  placeholder="Mô tả ngắn">{{$sim->description}}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">Nội dung</label>
                                        <textarea class="form-control" id="content" name="content"
                                                  rows="10">{{$sim->content}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="status">
                                            <option value=1 {{$sim->status==1?'selected':''}}>Publish</option>
                                            <option value=0 {{$sim->status==0?'selected':''}}>Disable</option>
                                        </select>
                                    </div>
