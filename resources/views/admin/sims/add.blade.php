...
@section('page-header')
    <!-- PAGE-HEADER -->
    <div>
        <h1 class="page-title">Thêm mới Sim</h1>
        <ol class="breadcrumb">
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <form action="{{route('admin.sim.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="type_of_sim"
