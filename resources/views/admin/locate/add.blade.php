...
@section('page-header')
    <!-- PAGE-HEADER -->
    <div>
        <h1 class="page-title">Thêm mới Thiết bị định vị</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Admin</a></li>
            <li class="breadcrumb-item"><a href="{{route('admin.locate.index')}}">Thiết bị định vị</a></li>
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <form action="{{route('admin.locate.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
