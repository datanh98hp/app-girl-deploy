...
@section('page-header')
    ...
    <div>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('admin.smartphone.index')}}">sim</a></li>
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <form action="{{route('admin.smartphone.update',$smartphone->id)}}" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" value="{{$smartphone->name}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="code" value="{{$smartphone->code}}"
                                               placeholder="Mã">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">Năm sản xuất</label>
                                        <input type="text" class="form-control" name="year" value="{{$smartphone->year}}"
                                               placeholder="Năm sản xuất">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">Giá cũ</label>
                                        <input type="text" class="form-control" name="price_old"
                                               value="{{$smartphone->price_old}}"
                                               placeholder="Giá cũ">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="description" rows="3"
                                                  placeholder="Mô tả ngắn">{{$smartphone->description}}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">Nội dung</label>
                                        <textarea class="form-control" id="content" name="content"
                                                  rows="10">{{$smartphone->content}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="status">
                                            <option value=1 {{$smartphone->status==1?'selected':''}}>Publish</option>
                                            <option value=0 {{$smartphone->status==0?'selected':''}}>Disable</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="image" class="dropify"
                                               data-default-file="{{$smartphone->image}}"/>
                                    </div>
