            ...
            <div class="card">
                <div class="card-header ">
                    <div class="text-right col-md-12">
                        <a href="{{route('admin.bill.create')}}" class="btn btn-primary">Thêm mới</a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="category-table" class="table table-striped table-bordered text-nowrap w-100">
                            ...
                            <tr>
                                ...
                                <th class="wd-15p">Khách hàng</th>
                                <th class="wd-15p">Email</th>
                                <th class="wd-15p">Số điện thoại</th>
                                <th class="wd-15p">Sản phẩm</th>
                                <th class="wd-15p">Giá</th>
                                <th class="wd-15p">Địa chỉ</th>
                                <th class="wd-15p">Ngày đặt</th>
                                <th class="wd-15p">Ghi chú</th>
