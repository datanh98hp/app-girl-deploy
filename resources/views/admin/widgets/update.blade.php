...
@section('page-header')
    ...
    <div>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('admin.bank.index')}}">Ngân hàng</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="number" value="{{$bank->number}}"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="status">
                                            ...
                                            <option value=0 {{$bank->status==0?'selected':''}}>Tạm dừng</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
