...
@section('page-header')
    <!-- PAGE-HEADER -->
    <div>
        <h1 class="page-title">Danh sách Ngân hàng</h1>
        <ol class="breadcrumb">
            ...
            <div class="card">
                <div class="card-header ">
                    <div class="text-right col-md-12">
                        <a href="{{route('admin.bank.create')}}" class="btn btn-primary">Thêm mới</a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="category-table" class="table table-striped table-bordered text-nowrap w-100">
                            ...
                            <tr>
                                ...
                                <th class="wd-15p">Chủ tài khoản</th>
                                <th class="wd-15p">Số tài khoản</th>
                                <th class="wd-15p">Chi nhánh</th>
