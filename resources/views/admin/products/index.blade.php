            ...
            <div class="card">
                <div class="card-header ">
                    <div class="text-right col-md-12">
                        ...
                        <a href="{{route("admin.product.resetFile")}}" class="btn btn-success ml-2" id="reset_image">Cập nhật lại ảnh của product</a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="post-table" class="table table-striped table-bordered text-nowrap w-100">
                            ...
                            <tr>
                                ...
                                <th class="wd-20p">Thương hiệu</th>
                                <th class="wd-20p">Lượt xem</th>
